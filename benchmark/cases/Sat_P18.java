...
public class Sat_P18 {
    public static void main(String[] args) {
        Phi phi = new Phi();
        Try tryFun = new Try();
        SatSolve18 satSolve18 = new SatSolve18();
        satSolve18.tryFun = tryFun;
        Boolean result = satSolve18.apply(phi);
    ...
    private static class Phi {
        public Boolean apply(Boolean x1, Boolean x2, Boolean x3, Boolean x4, Boolean x5, Boolean x6, Boolean x7, Boolean x8, Boolean x9, Boolean x10, Boolean x11, Boolean x12, Boolean x13, Boolean x14, Boolean x15, Boolean x16, Boolean x17, Boolean x18) {
    ...
    private static class SatSolve18 {
        ...
        public Boolean apply(Phi phi) {
            ...
            public Boolean apply(Boolean n18) {
                boolean resVal = phi.apply(n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17, n18);
