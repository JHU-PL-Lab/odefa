...
public class Sat_P10 {
    public static void main(String[] args) {
        Phi phi = new Phi();
        Try tryFun = new Try();
        SatSolve10 satSolve10 = new SatSolve10();
        satSolve10.tryFun = tryFun;
        Boolean result = satSolve10.apply(phi);
    ...
    private static class Phi {
        public Boolean apply(Boolean x1, Boolean x2, Boolean x3, Boolean x4, Boolean x5, Boolean x6, Boolean x7, Boolean x8, Boolean x9, Boolean x10) {
    ...
    private static class SatSolve10 {
        ...
        public Boolean apply(Phi phi) {
            ...
            public Boolean apply(Boolean n10) {
                boolean resVal = phi.apply(n1, n2, n3, n4, n5, n6, n7, n8, n9, n10);
