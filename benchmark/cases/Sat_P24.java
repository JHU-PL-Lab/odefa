...
public class Sat_P24 {
    public static void main(String[] args) {
        Phi phi = new Phi();
        Try tryFun = new Try();
        SatSolve24 satSolve24 = new SatSolve24();
        satSolve24.tryFun = tryFun;
        Boolean result = satSolve24.apply(phi);
    ...
    private static class Phi {
        public Boolean apply(Boolean x1, Boolean x2, Boolean x3, Boolean x4, Boolean x5, Boolean x6, Boolean x7, Boolean x8, Boolean x9, Boolean x10, Boolean x11, Boolean x12, Boolean x13, Boolean x14, Boolean x15, Boolean x16, Boolean x17, Boolean x18, Boolean x19, Boolean x20, Boolean x21, Boolean x22, Boolean x23, Boolean x24) {
    ...
    private static class SatSolve24 {
        ...
        public Boolean apply(Phi phi) {
            ...
            public Boolean apply(Boolean n24) {
                boolean resVal = phi.apply(n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17, n18, n19, n20, n21, n22, n23, n24);
