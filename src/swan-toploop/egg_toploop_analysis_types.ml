...
type error =
  | Inexhaustive_match of uid * Abstract_store_set.t
  ...
  | If_depends_on_non_bool of uid * Abstract_store_set.t
  ...
  | Application_of_non_function
    of uid * uid * Abstract_store.t * Abstract_store_set.t
